...
<figcaption>Fig. 8 - Different versions of my pyUDPI interface schematic. Power connections are omitted for simplicity as they were simply like to like.</figcaption>
</figure>
...
This was pretty trivial to port compared to the rest of the system. Since it was entirely writen using the abstractions afforded 
by the "Wire.h" library I didn't have to change a line of code from V2!
